 ...
 */
//@WebService(endpointInterface = "com.jh.service.IUserService",
//      targetNamespace = "http://service.hjc.web.com/wsdl",serviceName = "UserServiceImpi" ,portName = "dao")
@Component
@WebService(name = "ServerServiceDemo", targetNamespace = "http://server.webservice.example.com",endpointInterface = "com.jh.service.IUserService")
